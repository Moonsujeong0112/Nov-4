...
from dot_led import dots_speed, print_first, printNum_dot, print_jong, print_middle #점자 표현 및 속도 제어
from cam_capture import camstart #주변사물 캡쳐
...
# 번역
flag_trans = 0
led_trans = LED(21) # LED는 3번핀
button_trans = Button(2) # 스위치는 2번핀
...
# 3색 led- 속도제어
flag_speed = 0
led_speed = RGBLED(red=18, green=12, blue=13)
