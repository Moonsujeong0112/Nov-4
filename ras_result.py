...
import sys, re
from depart import korean_to_be_englished 
...
def scan_image():
  ...
  result = reader.readtext("카메라시연결과1.jpeg")
  img    = cv2.imread("카메라시연결과1.jpeg")
